  ...
  <div>
    ...
    <div class="container mx-auto my-12 md:my-16">
      ...
      <div>
        <div v-if="loading">
          <div
            class="flex flex-col space-y-10 lg:space-y-0 lg:flex-row lg:space-x-16 animate-pulse"
          >
            <div
        ...
        <div
          class="flex flex-col space-y-10 lg:space-y-0 lg:flex-row lg:space-x-16"
          v-else
        >
          <div
            class="lg:w-6/12 flex flex-col-reverse lg:flex-row items-start lg:space-x-10"
