    ...
    >
      ...
      <div class="grow">
        <div class="flex flex-col space-y-4">
          <div
            class="font-windsor-pro-black text-[#FAA551] text-center text-3xl md:text-5xl"
          >
